...
- **Training Data**: Be aware that some AI tools may generate code that is
  ...
  [our license](https://github.com/munich-quantum-toolkit/problemsolver/blob/main/LICENSE).

## Extractive Contributions

Processing pull requests and comments for MQT ProblemSolver requires significant
