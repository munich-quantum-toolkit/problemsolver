...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/problemsolver/issues>.
...
for MQT ProblemSolver.
If you are sure that the dependency update does not introduce any breaking
changes for MQT ProblemSolver, you can remove the {code}`minor` or {code}`major`
label from the PR.
