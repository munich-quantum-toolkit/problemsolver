...
def _generate_benchmarks(benchmarks_and_sizes: list[tuple[str, list[int]]]) -> Iterator[QuantumCircuit]:
...
def _circuit_generator(
    ...
    if path:
        ...
        yield from _generate_benchmarks(benchmarks_and_sizes)
    else:
