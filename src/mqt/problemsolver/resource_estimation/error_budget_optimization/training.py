...
def train(
    ...
    and then trains a Random Forest Regressor on the training set.

    Args:
        data: Training data generated by :func:`~.error_budget_optimization.generate_data.generate_data`.
