...
def test_tsp(encoding_type: pf.EncodingType) -> None:
    ...
    if encoding_type != cf.EncodingType.BINARY:
        ...
        assert generator.get_cost(optimal_solution) == pytest.approx(20.0)
    ...
    assert generator.get_cost(solution) == pytest.approx(20.0)
...
def test_2dpp(encoding_type: pf.EncodingType) -> None:
    ...
    assert generator.get_cost(solution) == pytest.approx(9.0)
