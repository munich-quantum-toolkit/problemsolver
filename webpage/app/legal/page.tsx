  ...
  return (
    <main className="flex h-screen flex-col items-center font-sans overflow-x-hidden">
      <nav className="flex items-center justify-between w-screen bg-slate-100 p-5">
        ...
        <a href="#" className="text-gray-900 font-medium hidden md:block">
          Legal Information
        </a>
        <a href="#" className="text-gray-900 font-medium block md:hidden">
      ...
      <div className="w-full h-full p-10 pl-[20%] pr-[20%] flex flex-col gap-5">
        ...
        <div>
          <div>
            <b>Rechtsform und Vertretung</b>
          </div>
          <div>
            Die Technische Universität München ist eine Körperschaft des
            Öffentlichen Rechts und staatliche Einrichtung (Art. 11 Abs. 1
            BayHSchG). Sie wird gesetzlich vertreten durch den Präsidenten Prof.
            Dr. Thomas F. Hofmann.
          </div>
        </div>
        ...
        <div>
          <div>
            <b>Umsatzsteueridentifikationnummer</b>
          </div>
        ...
        <div>
          ...
          <div>
            Texte, Bilder, Grafiken sowie die Gestaltung dieses Webauftritts
            können dem Urheberrecht unterliegen. Nicht urheberrechtlich
            geschützt sind nach § 5 des Urheberrechtsgesetz (UrhG)
          </div>
          <ul>
            <li>
        ...
        <div>
          ...
          verwenden. Eine Vervielfältigung oder Verwendung urheberrechtlich
          geschützten Materials dieser Seiten oder Teilen davon in anderen
          elektronischen oder gedruckten Publikationen und deren
          ...
          mit Quellenangabe allgemein gestattet.
        </div>

        <div>
          Weiterhin können Texte, Bilder, Grafiken und sonstige Dateien ganz
        ...
        <div>
          ...
          <div>
            Alle in diesem Webauftritt bereitgestellten Informationen haben wir
            ...
            allerdings nicht übernehmen. In Vertragsverhältnis mit den Nutzern
            des Webauftritts kommt nicht zustande.
          </div>
        </div>

        <div>
          Wir haften nicht für Schäden, die durch die Nutzung dieses
          Webauftritts entstehen. Dieser Haftungsausschluss gilt nicht, soweit
          ...
          Nutzung von Software verursacht werden, übernehmen wir keine Haftung.
        </div>
        ...
        <div>
          ...
          <div>
            Von unseren eigenen Inhalten sind Querverweise (&quot;Links&quot;)
            auf die Webseiten anderer Anbieter zu unterscheiden. Durch diese
            Links ermöglichen wir lediglich den Zugang zur Nutzung fremder
            Inhalte nach § 8 Telemediengesetz. Bei der erstmaligen Verknüpfung
            mit diesen Internetangeboten haben wir diese fremden Inhalte
            ...
            fremden Inhalte aber nicht ständig auf Veränderungen überprüfen und
            daher auch keine Verantwortung dafür übernehmen. Für illegale,
