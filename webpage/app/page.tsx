  ...
  return (
    <main className="flex h-screen flex-col items-center font-sans">
      <nav className="flex items-center justify-between w-screen bg-slate-100 p-5">
        ...
        <a target="_blank" href="https://www.cda.cit.tum.de/research/quantum/" className="text-gray-900 font-medium hidden md:block"><Image alt="MQT" src={"https://raw.githubusercontent.com/munich-quantum-toolkit/.github/refs/heads/main/docs/_static/logo-mqt-light.svg"} width={120} height={1} unoptimized></Image></a>
